...
class ReachabilityTests: XCTestCase {
    ...
    func testValidHost() {
        ...
        guard let reachability = try? InternetReachability(hostname: validHostName) else {
    ...
    func testInvalidHost() {
        ...
        guard let reachability = try? InternetReachability(hostname: invalidHostName) else {
            return XCTFail("Unable to create reachability")
        }
